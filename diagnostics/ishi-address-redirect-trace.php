...
final class Ishi_Address_Redirect_Trace {
    ...
    public static function boot() {
        // Run immediately before the address controller's PHP_INT_MAX redirect guard.
    ...
    private static function log( $message, $context ) {
        ...
        if ( function_exists( 'wc_get_logger' ) ) {
            try {
                ...
                // Fall through to the PHP error log if WooCommerce logging is unavailable.
            }
        }
    ...
    public static function trace_redirect( $location, $status = 302 ) {
        ...
        // Observation only: preserve the redirect exactly as requested.
        return $location;
    }
}
