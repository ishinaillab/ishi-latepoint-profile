...
if ( ! isset( $context, $customer, $user, $field_required, $form_id, $id_suffix, $return_url ) || ! class_exists( 'Ishi_LatePoint_Profile' ) ) {
    return;
}
...
<div class="woocommerce ishi-profile-shortcode">
    ...
    <form id="<?php echo esc_attr( $form_id ); ?>" class="woocommerce-EditAccountForm edit-account ishi-edit-account-form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
        ...
        <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name<?php echo esc_attr( $id_suffix ); ?>" autocomplete="given-name" value="<?php echo esc_attr( $customer->first_name ); ?>" aria-required="<?php echo $field_required( 'first_name' ) ? 'true' : 'false'; ?>" maxlength="255" />
        </p>
        <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_last_name" id="account_last_name<?php echo esc_attr( $id_suffix ); ?>" autocomplete="family-name" value="<?php echo esc_attr( $customer->last_name ); ?>" aria-required="<?php echo $field_required( 'last_name' ) ? 'true' : 'false'; ?>" maxlength="255" />
        </p>
        <div class="clear"></div>
        ...
        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
            ...
            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name<?php echo esc_attr( $id_suffix ); ?>" aria-describedby="account_display_name_description<?php echo esc_attr( $id_suffix ); ?>" value="<?php echo esc_attr( $user->display_name ); ?>" aria-required="true" maxlength="250" />
        ...
        <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
            ...
            <input type="tel" class="woocommerce-Input woocommerce-Input--phone input-text" name="account_phone" id="account_phone<?php echo esc_attr( $id_suffix ); ?>" autocomplete="tel" value="<?php echo esc_attr( $customer->phone ); ?>" aria-required="<?php echo $field_required( 'phone' ) ? 'true' : 'false'; ?>" maxlength="255" />
        </p>
        <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
            ...
            <input type="email" class="woocommerce-Input woocommerce-Input--email input-text" name="account_email" id="account_email<?php echo esc_attr( $id_suffix ); ?>" autocomplete="email" value="<?php echo esc_attr( $customer->email ); ?>" aria-required="<?php echo $field_required( 'email' ) ? 'true' : 'false'; ?>" maxlength="100" />
        </p>
        ...
        <fieldset>
            ...
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                ...
                <input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_current" id="password_current<?php echo esc_attr( $id_suffix ); ?>" autocomplete="current-password" />
            </p>
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                ...
                <input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_1" id="password_1<?php echo esc_attr( $id_suffix ); ?>" autocomplete="new-password" aria-describedby="password_help<?php echo esc_attr( $id_suffix ); ?>" />
            ...
            <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                ...
                <input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_2" id="password_2<?php echo esc_attr( $id_suffix ); ?>" autocomplete="new-password" />
            </p>
        </fieldset>
        <div class="clear"></div>
        ...
        <p>
            ...
            <button type="submit" class="woocommerce-Button button<?php echo esc_attr( $button_class ? ' ' . $button_class : '' ); ?>" name="ishi_lp_submit" value="1"><?php esc_html_e( 'Save changes', 'ishi-latepoint-profile' ); ?></button>
